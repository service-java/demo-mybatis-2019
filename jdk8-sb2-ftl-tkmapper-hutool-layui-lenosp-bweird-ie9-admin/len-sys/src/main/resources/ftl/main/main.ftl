        ...
        <div class="layui-hide-xs">
            <ul class="layui-nav layui-layout-left kit-nav">
                ...
                <li class="layui-nav-item">
                    <a href="javascript:;" data-options="{url:'/article/articleList',icon:'&#xe658;',title:'文章管理',id:'966'}">文章管理</a>
                </li>
        ...
        <ul class="layui-nav layui-layout-right kit-nav">
            <li class="layui-nav-item">
                ...
                <dl class="layui-nav-child skin">
                    <dd><a href="javascript:;" data-skin="default" style="color:#393D49;">默认</a></dd>
                    <dd><a href="javascript:;" data-skin="blue.1" style="color:#00c0ef;">天空蓝</a></dd>
...
<@tree data=menu start="start" end="end"/>
    ...
    <div class="layui-footer">
        <!-- 底部固定区域 -->
        2017 &copy;
        <a target="_blank" href="https://my.oschina.net/u/3312115/blog">开源中国博客</a>
