...
public class CmsChannelContent extends BaseEntity {
	...
	// alias
	/*
	 * public static final String TABLE_ALIAS = "栏目内容中间表"; public static final
	 * String ALIAS_ID = "id"; public static final String ALIAS_SITEID = "siteId";
	 * public static final String ALIAS_CHANNELID = "channelId"; public static final
	 * String ALIAS_CONTENTID = "contentId"; public static final String ALIAS_SORTNO
	 * = "排序"; public static final String ALIAS_ACTIVE = "状态 0不可用,1可用";
	 */
	// date formats
	...
	public CmsChannelContent(java.lang.String id) {
		this.id = id;
	}
	...
	public String toString() {
		return new StringBuilder().append("id[").append(getId()).append("],").append("siteId[").append(getSiteId())
				.append("],").append("channelId[").append(getChannelId()).append("],").append("contentId[")
				.append(getContentId()).append("],").append("排序[").append(getSortno()).append("],")
