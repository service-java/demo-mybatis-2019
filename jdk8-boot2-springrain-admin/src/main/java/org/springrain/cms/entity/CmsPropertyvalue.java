...
public class CmsPropertyvalue extends BaseEntity {
	...
	// alias
	/*
	 * public static final String TABLE_ALIAS = "自定义属性对应值表"; public static final
	 * String ALIAS_ID = "id"; public static final String ALIAS_PROPERTYID =
	 * "propertyId"; public static final String ALIAS_PVALUE = "pvalue"; public
	 * static final String ALIAS_SITEID = "siteId"; public static final String
	 * ALIAS_BUSINESSID = "业务Id"; public static final String ALIAS_SORTNO = "排序";
	...
	public CmsPropertyvalue(java.lang.String id) {
		this.id = id;
	}
	...
	public String toString() {
		return new StringBuilder().append("id[").append(getId()).append("],").append("propertyId[")
				.append(getPropertyId()).append("],").append("pvalue[").append(getPvalue()).append("],")
				.append("siteId[").append(getSiteId()).append("],").append("业务Id[").append(getBusinessId()).append("],")
				.append("排序[").append(getSortno()).append("],").append("状态 0不可用,1可用[").append(getActive()).append("],")
				.toString();
	}
