...
public class CmsComment extends BaseEntity {
	...
	// alias
	/*
	 * public static final String TABLE_ALIAS = "CMS评论表"; public static final String
	 * ALIAS_ID = "id"; public static final String ALIAS_USERID = "评论用户ID"; public
	 * static final String ALIAS_BUSINESSID = "业务Id"; public static final String
	 * ALIAS_PCOMMENTID = "父级评论Id"; public static final String ALIAS_SITEID =
	 * "站点ID"; public static final String ALIAS_CREATEDATE = "评论时间"; public static
	 * final String ALIAS_IP = "IP地址"; public static final String ALIAS_CONTENT =
	 * "评论内容"; public static final String ALIAS_UPS = "支持数"; public static final
	 * String ALIAS_DOWNS = "反对数"; public static final String ALIAS_CHECKED =
	 * "是否审核"; public static final String ALIAS_SCORE = "评分";
	 */
	// date formats
	...
	public CmsComment(java.lang.String id) {
		this.id = id;
	}
	...
	public String toString() {
		return new StringBuilder().append("id[").append(getId()).append("],").append("评论用户ID[").append(getUserId())
				.append("],").append("业务Id[").append(getBusinessId()).append("],").append("父级评论Id[").append(getPid())
				.append("],").append("站点ID[").append(getSiteId()).append("],").append("评论时间[").append(getCreateDate())
				.append("],").append("IP地址[").append(getIp()).append("],").append("评论内容[").append(getContent())
				.append("],").append("支持数[").append(getUps()).append("],").append("反对数[").append(getDowns())
				.append("],").append("是否审核[").append(getChecked()).append("],").append("评分[").append(getScore())
				.append("],").toString();
	}
