...
public class SiteController extends SiteBaseController {
	 ...
	 */
	@RequestMapping("/list")
	public String list(HttpServletRequest request, Model model, CmsSite cmsSite, @PathVariable String siteId,
	...
	public String updatepre(Model model, HttpServletRequest request, HttpServletResponse response, CmsSite cmsSite,
