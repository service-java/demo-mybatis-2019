...
public class RoleOrg extends BaseEntity {
	...
	// alias
	/*
	 * public static final String TABLE_ALIAS = "角色部门中间表"; public static final
	 * String ALIAS_ID = "编号"; public static final String ALIAS_ROLEID = "角色编号";
	 * public static final String ALIAS_ORGID = "部门编号"; public static final String
	 * ALIAS_ORGTYPE = "0组织机构 ,1.部门,2.虚拟权限组"; public static final String
	 * ALIAS_HASLEAF = "是否包含子部门,0不包含,1包含"; public static final String ALIAS_MANAGER
	 * = "0:非主管，1:主管"; public static final String ALIAS_ACTIVE = "是否可用,0不可用,1可用";
	 * public static final String ALIAS_BAK1 = "bak1"; public static final String
	 * ALIAS_BAK2 = "bak2"; public static final String ALIAS_BAK3 = "bak3";
	 */
	// date formats
	...
	public RoleOrg(java.lang.String id) {
		this.id = id;
	}
	...
	public String toString() {
		return new StringBuilder().append("编号[").append(getId()).append("],").append("角色编号[").append(getRoleId())
				.append("],").append("部门编号[").append(getOrgId()).append("],").append("0组织机构 ,1.部门,2.虚拟权限组[")
				.append(getOrgType()).append("],").append("是否包含子部门,0不包含,1包含[").append(getHasLeaf()).append("],")
				.append("0:非主管，1:主管[").append(getManager()).append("],").append("是否可用,0不可用,1可用[").append(getActive())
				.append("],").append("bak1[").append(getBak1()).append("],").append("bak2[").append(getBak2())
				.append("],").append("bak3[").append(getBak3()).append("],").toString();
	}
