...
public class Menu extends BaseEntity {
	...
	// alias
	/*
	 * public static final String TABLE_ALIAS = "Menu"; public static final String
	 * ALIAS_ID = "id"; public static final String ALIAS_NAME = "name"; public
	 * static final String ALIAS_PID = "pid"; public static final String
	 * ALIAS_DESCRIPTION = "description"; public static final String ALIAS_PAGEURL =
	 * "pageurl"; public static final String ALIAS_TYPE = "0.普通资源1.菜单资源"; public
	 * static final String ALIAS_SYSTEMID = "systemId"; public static final String
	 * ALIAS_ACTIVE = "active";
	 */
	// date formats
	...
	public String toString() {
		return new StringBuilder().append("主键id[").append(getId()).append("],").append("菜单名称[").append(getName())
				.append("],").append("父类id[").append(getPid()).append("],").append("描述[").append(getDescription())
				.append("],").append("跳转URL[").append(getPageurl()).append("],").append("0.功能按钮,1.导航菜单[")
				.append(getMenuType()).append("],").append("是否有效(0否,1是)[").append(getActive()).append("],")
				.append("排序[").append(getSortno()).append("],").append("菜单图标[").append(getMenuIcon()).append("],")
