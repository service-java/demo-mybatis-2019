...
<table class="table table-bordered table-hover">
	...
	<tr>
		...
		<td><%=quantity %></td>
		<td>
			<a href="buy.jsp?type=add&price=<%=price%>&bookname=<%=java.net.URLEncoder.encode(bookname,"UTF-8") %>">
				<span class="glyphicon glyphicon-plus">
			</a>
			<a href="buy.jsp?type=del&price=<%=price%>&bookname=<%=java.net.URLEncoder.encode(bookname,"UTF-8") %>">
