...
public class SpringAnnotationBeanNameGenerator {
	/*
	 * @Override public String generateBeanName(BeanDefinition definition,
	 * BeanDefinitionRegistry registry) { String
	 * s=super.generateBeanName(definition, registry); System.out.println(s);
	 * 
