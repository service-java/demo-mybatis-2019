...
public class CmsThemeTemplate extends BaseEntity {
	...
	// alias
	/*
	 * public static final String TABLE_ALIAS = "主题和模板中间表"; public static final
	 * String ALIAS_ID = "ID"; public static final String ALIAS_THEMEID = "主题Id";
	...
	public CmsThemeTemplate(java.lang.String id) {
		this.id = id;
	}
	...
	public String toString() {
		return new StringBuilder().append("ID[").append(getId()).append("],").append("主题Id[").append(getThemeId())
				.append("],").append("模板Id[").append(getTemplateId()).append("],").toString();
	}
