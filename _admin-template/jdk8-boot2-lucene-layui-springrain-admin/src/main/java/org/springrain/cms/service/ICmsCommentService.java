...
public interface ICmsCommentService extends IBaseSpringrainService {
	 ...
	 * @throws IOException
	 */
	String saveWechatFile(String serverIds, String siteType, String siteId, String businessId)
	 ...
	 * @throws Exception
	 */
	List<CmsComment> findListByOpenId(String openId, String siteId, String businessId, Integer type) throws Exception;
