...
public class CmsCommentController extends BaseController {
	 ...
	 */
	@RequestMapping("/list")
	public String list(HttpServletRequest request, Model model, CmsComment cmsComment) throws Exception {
	...
	public void listexport(HttpServletRequest request, HttpServletResponse response, Model model, CmsComment cmsComment)
			throws Exception {
		// ==构造分页请求
		Page page = newPage(request);
	...
	@ResponseBody
	public ReturnDatas saveorupdate(Model model, CmsComment cmsComment, HttpServletRequest request,
		...
		try {
			 ...
			 * cmsComment.setContent(SensitiveWordUtils.validateBanWords(cmsComment.
			 * getContent(), filePath));
			 */
	...
	@ResponseBody
	public ReturnDatas attachSaveorupdate(Model model, CmsComment cmsComment, HttpServletRequest request,
			HttpServletResponse response, @PathVariable String siteType, @PathVariable String siteId,
	...
	@ResponseBody
	public ReturnDatas commentFromWeiXin(HttpServletRequest req, HttpServletResponse res, Model model,
			@PathVariable String siteId, @PathVariable String businessId, CmsComment cmsComment) {
