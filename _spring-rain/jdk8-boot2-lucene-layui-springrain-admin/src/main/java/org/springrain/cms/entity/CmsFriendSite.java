...
public class CmsFriendSite extends BaseEntity {
	...
	// alias
	/*
	 * public static final String TABLE_ALIAS = "友情链接"; public static final String
	 * ALIAS_ID = "id"; public static final String ALIAS_SITEID = "siteId"; public
	 * static final String ALIAS_NAME = "name"; public static final String
	 * ALIAS_LINKTYPE = "跳出类型,_blank"; public static final String ALIAS_URL =
	 * "网站地址"; public static final String ALIAS_LOGO = "网站logo"; public static final
	...
	public CmsFriendSite(java.lang.String id) {
		this.id = id;
	}
	...
	public String toString() {
		return new StringBuilder().append("id[").append(getId()).append("],").append("siteId[").append(getSiteId())
				.append("],").append("name[").append(getName()).append("],").append("跳出类型,_blank[")
				.append(getLinkType()).append("],").append("网站地址[").append(getUrl()).append("],").append("网站logo[")
				.append(getLogo()).append("],").append("排序[").append(getSortno()).append("],").append("状态 0不可用,1可用[")
