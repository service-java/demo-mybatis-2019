...
public class CmsTemplate extends BaseEntity {
	...
	// alias
	/*
	 * public static final String TABLE_ALIAS = "模板表"; public static final String
	 * ALIAS_ID = "ID"; public static final String ALIAS_NAME = "名称"; public static
	 * final String ALIAS_DESCRIPTION = "备注"; public static final String
	 * ALIAS_FTLFILE = "渲染使用的模板路径"; public static final String ALIAS_IMGFILE =
	 * "缩略图路径路径"; public static final String ALIAS_MODELTYPE =
	 * "0site,1channel,2content,3投票(以后可能扩展更多系统功能,例如 注册 登录 订单 购物车)"; public static
	 * final String ALIAS_USECOUNT = "使用次数"; public static final String ALIAS_ACTIVE
	 * = "状态 0不可用,1可用";
	 */
	// date formats
	...
	public CmsTemplate(java.lang.String id) {
		this.id = id;
	}
	...
	public String toString() {
		return new StringBuilder().append("ID[").append(getId()).append("],").append("名称[").append(getName())
				.append("],").append("备注[").append(getDescription()).append("],").append("渲染使用的模板路径[")
				.append(getFtlfile()).append("],").append("缩略图路径路径[").append(getImgfile()).append("],")
				.append("0site,1channel,2content,3投票(以后可能扩展更多系统功能,例如 注册 登录 订单 购物车)[").append(getModelType())
				.append("],").append("使用次数[").append(getUsecount()).append("],").append("状态 0不可用,1可用[")
