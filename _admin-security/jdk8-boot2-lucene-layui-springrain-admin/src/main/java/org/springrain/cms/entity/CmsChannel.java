...
public class CmsChannel extends BaseEntity {
	...
	// alias
	/*
	 * public static final String TABLE_ALIAS = "栏目表"; public static final String
	 * ALIAS_ID = "id"; public static final String ALIAS_NAME = "名称"; public static
	 * final String ALIAS_PID = "pid"; public static final String ALIAS_COMCODE =
	 * "comcode"; public static final String ALIAS_SITEID = "网站ID"; public static
	 * final String ALIAS_POSITIONLEVEL = "0导航,1-10个级别"; public static final String
	 * ALIAS_TITLE = "标题"; public static final String ALIAS_KEYWORDS = "关键字"; public
	 * static final String ALIAS_DESCRIPTION = "描述"; public static final String
	 * ALIAS_LOOKCOUNT = "打开次数"; public static final String ALIAS_SORTNO = "排序";
	...
	public String toString() {
		return new StringBuilder().append("id[").append(getId()).append("],").append("名称[").append(getName())
				.append("],").append("pid[").append(getPid()).append("],").append("comcode[").append(getComcode())
				.append("],").append("网站ID[").append(getSiteId()).append("],").append("0导航,1-10个级别[")
				.append(getPositionLevel()).append("],").append("关键字[").append(getKeywords()).append("],").append("描述[")
				.append(getDescription()).append("],").append("打开次数[").append(getLookcount()).append("],").append("排序[")
				.append(getSortno()).append("],").append("状态 0不可用,1可用[").append(getActive()).append("],").toString();
	}
