...
public class CmsLink extends BaseEntity {
	...
	// alias
	/*
	 * public static final String TABLE_ALIAS = "业务链接表"; public static final String
	 * ALIAS_ID = "id"; public static final String ALIAS_NAME = "name"; public
	 * static final String ALIAS_DEFAULTLINK = "默认URL地址"; public static final String
	 * ALIAS_LINK = "使用的URL"; public static final String ALIAS_SITEID = "网站ID";
	 * public static final String ALIAS_BUSINESSID = "业务Id"; public static final
	 * String ALIAS_LOOKCOUNT = "打开次数"; public static final String ALIAS_MODELTYPE =
	 * " 0使用freemarker模板,1redirect,2forward"; public static final String
	 * ALIAS_FTLFILE = "当前渲染使用的模板路径"; public static final String ALIAS_NODEFTLFILE =
	 * "子内容使用的ftl模板文件"; public static final String ALIAS_STATICHTML = "是否静态化 0否,1是";
	 * public static final String ALIAS_SORTNO = "排序"; public static final String
	 * ALIAS_ACTIVE = "状态 0不可用,1可用";
	 */
	// date formats
	...
	public CmsLink(java.lang.String id) {
		this.id = id;
	}
	...
	public String toString() {
		return new StringBuilder().append("id[").append(getId()).append("],").append("name[").append(getName())
				.append("],").append("默认URL地址[").append(getDefaultLink()).append("],").append("使用的URL[")
				.append(getLink()).append("],").append("网站ID[").append(getSiteId()).append("],").append("业务Id[")
				.append(getBusinessId()).append("],").append("打开次数[").append(getLookcount()).append("],")
				.append("0使用freemarker模板,1redirect,2forward[").append(getJumpType()).append("],").append("当前渲染使用的模板路径[")
				.append(getFtlfile()).append("],").append("子内容使用的ftl模板文件[").append(getNodeftlfile()).append("],")
				.append("是否静态化 0否,1是[").append(getStatichtml()).append("],").append("排序[").append(getSortno())
				.append("],").append("状态 0不可用,1可用[").append(getActive()).append("],").append("modelType[")
				.append(getModelType()).append("],").append("siteType[").append(getSiteType()).append("],").toString();
	}
