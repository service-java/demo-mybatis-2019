 ...
 * 标签基类
 */
public abstract class AbstractCMSDirective implements TemplateDirectiveModel {
	 ...
	 */
	public static int getOrderBy(Map<String, TemplateModel> params) throws TemplateException {
