...
public class CmsSite extends BaseEntity {
	...
	// alias
	/*
	 * public static final String TABLE_ALIAS = "站点表"; public static final String
	 * ALIAS_ID = "id"; public static final String ALIAS_USERID = "用户Id"; public
	 * static final String ALIAS_NAME = "名称"; public static final String ALIAS_TITLE
	 * = "title"; public static final String ALIAS_DOMAINURL = "网站域名"; public static
	 * final String ALIAS_LOGO = "网站logo"; public static final String ALIAS_FOOTER =
	 * "页脚"; public static final String ALIAS_QQ = "QQ"; public static final String
	 * ALIAS_PHONE = "电话"; public static final String ALIAS_CONTACTS = "联系人"; public
	 * static final String ALIAS_KEYWORDS = "keywords"; public static final String
	 * ALIAS_DESCRIPTION = "description"; public static final String ALIAS_THEMEID =
	 * "主题Id"; public static final String ALIAS_LOOKCOUNT = "打开次数"; public static
	 * final String ALIAS_SITETYPE = "0微信订阅服务号,1wap,2网站   "; public static final
	 * String ALIAS_ACTIVE = "状态 0不可用,1可用";
	 */
	// date formats
	...
	public String toString() {
		return new StringBuilder().append("id[").append(getId()).append("],").append("创建时间[").append(getCreateTime())
				.append("],").append("修改时间[").append(getModifyTime()).append("],").append("用户Id[").append(getUserId())
				.append("],").append("名称[").append(getName()).append("],").append("title[").append(getTitle())
				.append("],").append("网站域名[").append(getDomainurl()).append("],").append("网站logo[").append(getLogo())
				.append("],").append("页脚[").append(getFooter()).append("],").append("QQ[").append(getQq()).append("],")
				.append("电话[").append(getPhone()).append("],").append("联系人[").append(getContacts()).append("],")
				.append("keywords[").append(getKeywords()).append("],").append("description[").append(getDescription())
				.append("],").append("主题Id[").append(getThemeId()).append("],").append("打开次数[").append(getLookcount())
				.append("],").append("0微信订阅服务号,1wap,2网站   [").append(getSiteType()).append("],").append("状态 0不可用,1可用[")
				.append(getActive()).append("],").toString();
	}
