...
public class CmsPraise extends BaseEntity {
	...
	// alias
	/*
	 * public static final String TABLE_ALIAS = "点赞表"; public static final String
	 * ALIAS_ID = "id"; public static final String ALIAS_BUSINESSID = "业务id"; public
	 * static final String ALIAS_USERID = "点赞人";
	 */
	// date formats
	...
	public CmsPraise(java.lang.String id) {
		this.id = id;
	}
	...
	public String toString() {
		return new StringBuilder().append("id[").append(getId()).append("],").append("业务id[").append(getBusinessId())
				.append("],").append("点赞人[").append(getUserId()).append("],").toString();
	}
